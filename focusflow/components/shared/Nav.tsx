    ...
    icon: (active: boolean) => (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"
          fill={active ? '#5B6CF8' : 'none'}
          stroke={active ? '#5B6CF8' : 'currentColor'}
    ...
    icon: (active: boolean) => (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"
          stroke={active ? '#5B6CF8' : 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"
          stroke={active ? '#5B6CF8' : 'currentColor'} strokeWidth="2"/>
        <line x1="16" y1="2" x2="16" y2="6" stroke={active ? '#5B6CF8' : 'currentColor'} strokeWidth="2" strokeLinecap="round"/>
        <line x1="8" y1="2" x2="8" y2="6" stroke={active ? '#5B6CF8' : 'currentColor'} strokeWidth="2" strokeLinecap="round"/>
        <line x1="3" y1="10" x2="21" y2="10" stroke={active ? '#5B6CF8' : 'currentColor'} strokeWidth="2"/>
      </svg>
    ),
  },
  {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-border z-40 md:static md:border-t-0 md:border-r md:h-screen md:w-56 md:flex-col md:flex">
      <div className="flex md:flex-col md:flex-1 md:pt-6">
              ...
              <Link
                ...
                className={`
                  ...
                  ${active
                    ...
                    : 'text-text-muted hover:text-text md:hover:bg-gray-50'}
                `}
              >
                {item.icon(active)}
        ...
        {/* Settings + Sign out — desktop */}
        <div className="hidden md:flex flex-col gap-0.5 px-3 mt-auto pb-6">
          <Link
            href="/settings"
            className={`flex items-center gap-2.5 py-2.5 px-3 rounded-md text-sm font-medium transition-colors ${
              pathname === '/settings'
